...
class LoadCropsFromTrialsIterator(object):
    ...
    braindecode. However, it is adapted to work wih lazy datasets. It uses
    ...
    def get_batches(self, dataset, shuffle):
        batches = self._get_batches(dataset=dataset, shuffle=shuffle)
        dataloader = DataLoader(dataset=dataset, batch_sampler=batches,
